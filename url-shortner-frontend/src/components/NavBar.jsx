  ...
  return (
    <div className="h-16 bg-custom-gradient z-50 flex items-center sticky top-0">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between items-center">
        ...
        {/* Navigation Links */}
        <ul
          className={`flex sm:gap-10 gap-4 sm:items-center sm:mt-1 sm:pt-0 pt-3 
          text-slate-800 sm:static absolute left-0 top:62px 
          ...
          transition-all duration-100 sm:h-fit sm:bg-none 
          bg-custom-gradient sm:w-fit w-full sm:flex-row flex-col 
          px-4 sm:px-0`}
        >
          ...
          {!token && (
            <li>
              <Link
                to="/register"
                className="sm:ml-0 -ml-1 bg-rose-700 text-white 
                cursor-pointer w-24 text-center font-semibold 
                px-2 py-2 rounded-md hover:text-slate-300 
